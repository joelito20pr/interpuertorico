  ...
  const sponsorshipTiers = [
    {
      ...
      features: [
        ...
        "Enviar logo en buena resolución a interprfc@gmail.com",
      ],
      highlighted: true,
      ...
      <section className="w-full bg-gradient-to-r from-cyan-500 to-pink-500 text-white">
        <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col items-center">
          <div className="w-48 h-48 relative mb-8">
            <Image src="/placeholder-logo.png" alt="Inter Puerto Rico Logo" fill className="object-contain" priority />
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 flex justify-center">
              <div className="w-64 h-64 relative">
                <Image src="/placeholder-logo.png" alt="Inter Puerto Rico Logo" fill className="object-contain" />
              </div>
            </div>
